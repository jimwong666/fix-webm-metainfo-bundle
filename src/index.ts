 ...
 *
 */
export default async function fixWebmMetaInfo(blob: Blob, time: any): Promise<Blob> {
  ...
  const refinedMetadataBuf = tools.makeMetadataSeekable(reader.metadatas, parseFloat(time) || reader.duration, reader.cues);
